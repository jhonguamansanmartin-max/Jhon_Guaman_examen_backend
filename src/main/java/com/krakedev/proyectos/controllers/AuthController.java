...
public class AuthController {
	...
	public ResponseEntity<?> login(@RequestBody Map<String, String> credenciales) {
		...
		if (autenticado) {
			...
			return ResponseEntity.status(HttpStatus.UNAUTHORIZED).body("Username o password incorrecta");
	...
	public ResponseEntity<?> verPerfil() {
		...
		return ResponseEntity.ok(Map.of("Mensaje", "Bienvenido al sistema protegido por SpringSecurity", "Usuario",
